...
| :---:       |    :----:   |   :---:     |
|`[1, 2, 3, 4]`| 1 2 3 4|Fără elemente repetate |
|`[7, 8, 9, 7, 2, 3, 4, 1, 2]`| 7 8 9 2 3 4 1| `7` si` 2` sunt deja prezente în matrice \-\> eliminați-le |
|`[20, 8, 12, 13, 4, 4, 8, 5]`| 20 8 12 13 4 5|`4` si` 8` sunt deja prezente în matrice \-\> eliminați-le |
...
Dacă primiți primul tip de intrare, trebuie să **adăugați** persoana dacă nu se află în listă (Dacă se află în listă tipăriți: '{nume} este deja în listă ! `).

Dacă primiți cel de-al doilea tip de intrare, trebuie să **eliminați** persoana dacă se află în listă (dacă nu tipăriți: '{nume} nu este în listă!`).
