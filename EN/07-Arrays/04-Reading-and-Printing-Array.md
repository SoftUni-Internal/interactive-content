...
[code-task title="Problem: Print Numbers in Reverse Order" taskId="java-fundamentals-Arrays" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.Scanner;
...
[code-task title="Problem: Reverse an Array of Strings" taskId="java-fundamentals-Arrays" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.Scanner;
