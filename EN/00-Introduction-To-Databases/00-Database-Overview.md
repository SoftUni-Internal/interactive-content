...
[code-task title="Continents and Currencies" taskId="java-db-and-MySQL-subqueries-and-JOINs-continents-and-currencies" executionType="tests-execution" executionStrategy="mysql-prepare-db-and-run-queries" requiresInput]
...
| **econtinent_code** | **currency_code** |**currency_usage** |
| --- | --- | --- | 
|AF|XOF|8|
|AS	|AUD|2|
|AS|ILS|2|
...
[code-task title="Countries Without Any Mountains" taskId="java-db-and-MySQL-subqueries-and-JOINs-countries-without-any-mountains" executionType="tests-execution" executionStrategy="mysql-prepare-db-and-run-queries" requiresInput]
[code-editor language=sql]
...
[task-description]
# Description
Find the count of all countries which don not have a **mountain**.
