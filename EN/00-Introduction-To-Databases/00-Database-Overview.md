[slide hideTitle]
# Problem: Salary Challenge
[code-task title="Salary Challenge" taskId="java-db-and-mysql-built-in-functions-and-data-aggregation-salary-challenge" executionType="tests-execution" executionStrategy="mysql-prepare-db-and-run-queries" requiresInput]
...
Write a query that returns the following fields: 
