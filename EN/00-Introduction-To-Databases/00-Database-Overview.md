...
[code-task title="Min Average Salary" taskId="java-db-and-MySQL-subqueries-and-JOINs-min-average-salary" executionType="tests-execution" executionStrategy="mysql-prepare-db-and-run-queries" requiresInput]
[code-editor language=sql]
