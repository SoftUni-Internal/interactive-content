...
[code-task title="Find All Department Names" taskId="java-db-and-MySQL-basic-crud-find-all-department-names" executionType="tests-execution" executionStrategy="mysql-prepare-db-and-run-queries" requiresInput]
[code-editor language=sql]
...
[slide hideTitle]
# Problem: Find Each Employee's Full Name

[code-task title="Find Each Employee's Full Name" taskId="java-db-and-MySQL-basic-crud-find-each-full-name" executionType="tests-execution" executionStrategy="mysql-prepare-db-and-run-queries" requiresInput]
[code-editor language=sql]
...
[code-task title="Find Each Employee’s Email Address" taskId="java-db-and-MySQL-basic-crud-find-each-employees-email" executionType="tests-execution" executionStrategy="mysql-prepare-db-and-run-queries" requiresInput]
[code-editor language=sql]
...
Name the the resulting column as **full_ email_address**. 

The email addresses are not present in any of the tables but you can generate a list based on the first and last names of each employee, followed by the email domain. 

The emails should be in the following format: "John.Doe@softuni.bg".
...
[slide hideTitle]
# Problem: Find All Employees Without a Manager

[code-task title="Find All Employees Without a Manager" taskId="java-db-and-MySQL-basic-crud-find-employees-without-manager" executionType="tests-execution" executionStrategy="mysql-prepare-db-and-run-queries" requiresInput]
[code-editor language=sql]
...
[slide hideTitle]
# Problem: Find the Five Best-Paid Employees
...
TODO: Escape input and output with ``` if nothing works
