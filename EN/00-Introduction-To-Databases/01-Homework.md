...
[code-task title="Find Each Employee's Email Address" taskId="java-db-and-MySQL-basic-crud-find-each-employees-email-1" executionType="tests-execution" executionStrategy="mysql-prepare-db-and-run-queries" requiresInput]
