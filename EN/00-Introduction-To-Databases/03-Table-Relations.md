...
[code-task title="Employees by Salary Level" taskId="java-db-and-MySQL-database-programmability-employees-by-salary-level" executionType="tests-execution" executionStrategy="mysql-run-skeleton-run-queries-and-check-database" requiresInput]
...
[test]
[input]
CALL usp_get_employees_by_salary_level ('bla bla');
[/input]
[output]
