...
[slide hideTitle]
# Problem with Solution: Triggered - mysql-run-skeleton-run-queries-and-check-database (TSA3)
...
[slide hideTitle]
# Find All Information About Departments - mysql-prepare-db-and-run-queries (TSA1)
...
[slide hideTitle]
# mysql-run-queries-and-check-database (TSA2)
