...
[code-task title="Divisible by 3" taskId="java-fundamentals-Basic-Syntax" executionType="tests-execution" executionStrategy="java-code" requiresInput]
...
[code-task title="Sum of Odd Numbers" taskId="java-fundamentals-Basic-Syntax" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.Scanner;
...
[code-task title="Multiplication Table" taskId="java-fundamentals-Basic-Syntax" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.Scanner;
...
[code-task title="Multiplication Table 2.0" taskId="java-fundamentals-Basic-Syntax" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.Scanner;
