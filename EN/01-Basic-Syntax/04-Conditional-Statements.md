...
[code-task title="Back in 30 Minutes" taskId="java-fundamentals-Basic-Syntax-04" executionType="tests-execution" executionStrategy="java-code" requiresInput]
...
[code-task title="Month Printer" taskId="java-fundamentals-Basic-Syntax-04" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```java
import java.util.Scanner;
...
[code-task title="Foreign Languages" taskId="java-fundamentals-Basic-Syntax" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```java
import java.util.Scanner;
