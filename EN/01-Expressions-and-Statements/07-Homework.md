...
[slide]
# Video
[vimeo-video videoId="341506782" startTimeInSeconds="6196" endTimeInSeconds="10718" /]
...
[code-task title="Calculate Speed" taskId="pb-js-01-p-01" executionType="tests-execution" executionStrategy="javascript-code" requiresInput]
...
[code-task title="Area of Triangle" taskId="pb-js-01-p-03" executionType="tests-execution" executionStrategy="javascript-code" requiresInput]
[code-editor language="javascript"]
```
...
[code-task title="Four Operations" taskId="pb-js-01-p-04" executionType="tests-execution" executionStrategy="javascript-code" requiresInput]
[code-editor language="javascript"]
```
...
Write a program, which:
  ...
  * **Formats** the numbers to 2 digits after the decimal point
  * **Prints** the results like this example:
# Example
## Input
- 5.00
- 10.00
...
[slide]
# Problem: Person Info
[code-task title="Person Info" taskId="pb-js-01-p-07" executionType="tests-execution" executionStrategy="javascript-code" requiresInput]
[code-editor language="javascript"]
```
...
[slide]
# Problem: Town Info
[code-task title="Town Info" taskId="pb-js-01-p-08" executionType="tests-execution" executionStrategy="javascript-code" requiresInput]
[code-editor language="javascript"]
```
