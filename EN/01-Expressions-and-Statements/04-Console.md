...
[video src="https://videos.softuni.org/hls/javascript-basics/01.Expressions-and-Statements/EN/01-PB-JavaScript-expressions-and-statements-23-Problem-Greeting-solution-TRIM-,1080p,720p,480p,360p,240p,.mp4/urlset/master.m3u8" poster="" /]
...
[task-description]
# Description
Create a program, which reads a user's name from the console and then prints "**Hello,** \{**name**\}", where \{**name**\} is the user input.  
