...
[slide hideTitle]
# Problem: Shapes
[code-task title="Shapes" taskId="0c684294-b32a-4b85-8cd4-6b21ea8cebe3" executionType="tests-execution" executionStrategy="java-code" requiresInput]
...
[slide hideTitle]
# Solution: Shapes
[code-task title="Shapes" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.*;
...
[slide hideTitle]
# Problem: Animals
[code-task title="Animals" taskId="e110c8c9-9df4-4bef-828e-0274afc4b173" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.*;
...
[slide hideTitle]
# Solution: Animals
[code-task title="Animals" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.*;
