...
[test]
[input]
\# test 1 : 'manufacturers' table name and column names check
...
[test]
[input]
\# test 2 : 'models' table name and column names check
...
[test]
[input]
\# test 3 :  'manufacturers' table PK check
...
[test]
[input]
\# test 4 :  'manufacturers' table PK check
...
[test]
[input]
\# test 1 : 'students' table name and column names check
...
[test]
[input]
\# test 2 : 'exams' table name and column names check
SELECT lower(table_name)
FROM information_schema.TABLES
WHERE TABLE_SCHEMA = database() and lower(TABLE_NAME) = 'exams'
order by lower(table_name);
...
[test]
[input]
\# test 3 : 'students_exams' table name and column names check
...
[test]
[input]
\# test 4 :  'students' table PK check
...
[test]
[input]
\# test 7 : fk_students_exams_students check
...
[test]
[input]
\# test 8 : fk_students_exams_exams check
...
[code-task title="Problem: University Database" taskId="0dee8cc1-9ed2-4bb3-acf6-0b6baa32eac1" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.*;
