[slide]
# csharp-dot-net-core-code
[code-task title="Yard Greening" taskId="csharp-dot-net-core-code-statements-Yard-Greening" executionType="tests-execution" executionStrategy="csharp-dot-net-core-code" requiresInput]
...
public class MainClass {
    public static void Main() {
        var areaSqm = double.Parse(Console.ReadLine);
        var pricePerM=7.61;
        var percent=18*0.01;
        var totalPrice=pricePerM*areaSqm;
        var discount = percent*totalPrice;
        var finalPrice = totalPrice-discount;
        Console.WriteLine($"The final price is: {finalPrice:.2f} dollars\nThe discount is: {discount:.2f} dollars");
    }
}
```
[/code-editor]
