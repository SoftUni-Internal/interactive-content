...
In Java, we can create functions analogical to the mathematical functions.
...
// Where we have all needed components (Function type, Parameters, Name of the function and Return Expression)
...
We can use function with **`.apply()`**
...
[code-task title="Problem: Sum Numbers"  executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
