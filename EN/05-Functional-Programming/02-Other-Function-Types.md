...
[slide hideTitle]
# Problem: Add VAT
[code-task title="Problem: Add VAT" taskId="dd3197b3-aa3a-4a96-9a5d-7cf4b03f0659" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.io.BufferedReader;
import java.io.IOException;
...
[slide hideTitle]
# Solution: Add VAT
[code-task title="Problem: Add VAT" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.io.BufferedReader;
import java.io.IOException;
