...
You can create a static field by using the `static` keyword. 

The static fields have the same value in all instances of the class. 
...
[video src="https://videos.softuni.org/hls/Java/Java-OOP-Basics/01-Defining-Classes/EN/interactive-java-advanced-defining-classes-36-bank-account-solution-NEW2-,1080p,720p,480p,360p,240p,.mp4/urlset/master.m3u8" poster="" /]
