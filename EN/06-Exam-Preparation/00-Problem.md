...
First, you will be given **a sequence of integers, representing the first loot box**.
...
If the first loot box is empty, print:

`First lootbox is empty`

If the second loot box is empty, print:
...
- On the **first** line print which box got empty in the format described above.
- On the **second** line print the quality of your loot in the format described above.

## Constraints

- All of the given numbers will be valid integers in range [0 ... 100].
