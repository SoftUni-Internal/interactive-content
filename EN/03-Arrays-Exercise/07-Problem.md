...
[code-task title="Max Sequence of Equal Elements" taskId="java-fundamentals-arrays-7" executionType="tests-execution" executionStrategy="java-code" requiresInput]
