...
[code-task title="Stack of Strings" taskId="453de29f-62b0-402e-bff7-59ba14b9a7ca" executionType="tests-execution" executionStrategy="java-code" requiresInput]
...
[code-task title="Stack of Strings" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.*;
