...
For a natural number n, calculate **n! = 1 * 2 * 3 * … * n**. 
...
- We create another variable – a `fact` with an initial value of 1. 

We will use it for the calculation and storage of the factorial
