[slide]
# python-code
[code-task title="Yard Greening" taskId="pb-python-statements-Yard-Greening" executionType="tests-execution" executionStrategy="python-code" requiresInput]
[code-editor language=python]
```
area_sqm = float(input())
price_per_m = 7.61
percent = 18 * 0.01
total_price = price_per_m * area_sqm
discount = percent * total_price
