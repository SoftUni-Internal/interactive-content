...
[code-task title="Border Control" taskId="dd8b950d-a55d-4f6c-b20d-be36f8e2012d" executionType="tests-execution" executionStrategy="java-code" requiresInput]
...
[code-task title="Border Control" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.*;
