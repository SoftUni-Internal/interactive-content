...
[slide hideTitle]
# Problem: Ferrari
[code-task title="Ferrari" taskId="8b0c7e60-09d4-4929-b2b3-df0a2d34dffa" executionType="tests-execution" executionStrategy="java-code" requiresInput]
...
[slide hideTitle]
# Solution: Ferrari
[code-task title="Ferrari" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.*;
