...
Since the pieces are **not** in the collection, you add them. 
[/hint] 
[hint]
...
[/hint] 
[hint]
Next, you receive the "**Stop**" command.

You **print the information about the pieces**, sorted the way described above, and the program ends. 
[/hint] 
[/hints] 
