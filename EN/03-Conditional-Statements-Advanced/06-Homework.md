...
\* **Hint**: use one or more conditional **if** statements with logical operations. A point **{x, y}** lies on a side of a rectangle **{x1, y1} – {x2, y2}**, if one of the specified conditions is fulfilled:
...
You can check the conditions above using a single **if**-**else** construction or using a few, more simple conditional statements
[/task-description]
[tests]
[test open]
[input]
...
- **11 fishermen, hence 15% discount** -> **4200 - 15% = 3570** $, the number of people in this group is **odd** so they do **not** use the **additional** discount.
- 3000 <= 3570, they need 570.00 $ more
...
- In total the flowers are 20 or less - there **is no discount**
