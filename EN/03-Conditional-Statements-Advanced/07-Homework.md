...
[hints]
[hint]
Create a control variable **biggestNumber** at the beginning and assign it the value of the first number.
[/hint]
[hint]
Compare each of the input numbers, starting from the second number with the control variable.
