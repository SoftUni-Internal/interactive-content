...
[code-task title="Find Employees by First Name" taskId="java-db-and-mysql-built-in-functions-and-data-aggregation-find-employees-by-first-name" executionType="tests-execution" executionStrategy="mysql-prepare-db-and-run-queries" requiresInput]
