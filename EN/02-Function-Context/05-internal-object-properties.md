...
frozenObj.property1 = 'trying to change it'; // TypeError
```
...
``delete obj.property1`` was supposed to remove this property from the object, but since it is **sealed** it won't work.
