...
Clasa **HashSet** oferă **performanță** constantă în timp pentru operațiunile de bază - `add()`, `remove()`, `contains()` and `size()`.
...
Intrarea se termină cu șirul ”**SFÂRȘIT**”
...
## Descriere
Există o petrecere în SoftUni. Sunt invitați mulți oaspeți și sunt de două tipuri: **VIP** și **obișnuit**.
...
## Intrare
- Până la comanda **PETRECERE**, veți primi invitații pentru oaspeți.
- Până la comanda **SFÂRȘIT**, veți primi o a doua listă cu invitați care vin de fapt la petrecere.
## Ieșire
