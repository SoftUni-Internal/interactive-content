...
- Rezultatul (output sau ieșire) executării programului de mai sus este după cum urmează:
...
Există posibilitatea de a importa și utiliza o funcție în pagina noastră web.
...
Este important să introducem funcția `convertUsdToEur()` în scriptul nostru de html.
