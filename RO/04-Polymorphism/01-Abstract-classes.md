...
[slide hideTitle]
# Problem: Shapes
[code-task title="Problem: Shapes" taskId="0c684294-b32a-4b85-8cd4-6b21ea8cebe3" executionType="tests-execution" executionStrategy="java-code" requiresInput]
...
[slide hideTitle]
# Problem: Animals
[code-task title="Problem: Animals" taskId="e110c8c9-9df4-4bef-828e-0274afc4b173" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.*;
