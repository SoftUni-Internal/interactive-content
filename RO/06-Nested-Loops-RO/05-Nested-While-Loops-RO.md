...
Utilizarea buclelor imbricate `while` este foarte similară cu cea a buclelor imbricate `for`, dar acestea sunt utilizate atunci când nu cunoaștem cu exactitate numărul de repetări necesare.
