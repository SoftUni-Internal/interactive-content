...
Java oferă **clase gata de utilizare**, care sunt organizate în **Packages**. Aceste clase oferă metode și câmpuri predefinite care ajută la economisirea timpului și a efortului în scrierea codului și repetarea acestuia.

Exemplu: `java.util.Scanner;` `java.utils.List;` `java.lang.Math;` `java.math.BigInteger;`
...
Clasa `java.util.Random;` este utilizată pentru a genera numere aleatoare de tipuri întregi, plutitoare, duble, lungi. De asemenea, poate genera un tip boolean aleatoriu și poate întoarce rezultatul între `true` sau `false`.
...
[task-description]
## Descriere
Vi se oferă o **listă de cuvinte într-un singur rând**.

**Randomizați comanda lor** și tipăriți **fiecare cuvânt pe o linie separată**.

## Exemple

|**Intrare**|**Ieșire**|**Comentarii**|
| --- | --- | --- |
| Welcome to SoftUni and have fun learning programming | learning | Ordinea cuvintelor din ieșire va fi diferită după fiecare execuție a programului. |
| | Welcome | |
| | SoftUni | |
| | and | |
| | fun | |
