...
[slide hideTitle]
# Problem: Cards Game
[code-task title="Cards Game" taskId="java-fund-Lists-Exercise-Cards-Game" executionType="tests-execution" executionStrategy="java-code" requiresInput]
[code-editor language=java]
```
import java.util.*;
import java.util.stream.Collectors;
