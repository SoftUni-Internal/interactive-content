...
Va respecta întotdeauna regulile cu **același mode**:
...
* Numele articolului poate conține numai **litere mici**, **majuscule** **litere** și **spații**
...
Calculați **caloriile totale ale tuturor produselor alimentare** din șir și apoi determinați câte zile ați putea dura cu această cantitate, **presupunând că consumați 2000 kcal pe zi.**
...
Nu există chibrituri, ceea ce înseamnă că nu ai mâncare.

Acest text "\#Invalid food\#19/03/20\#450" is not a match, since it does not have a "\#" at the end.
