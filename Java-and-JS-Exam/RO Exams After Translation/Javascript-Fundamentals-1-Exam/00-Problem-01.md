...
Peter începe să se deplaseze în zona de tir cu arcul de la stânga începând de la „\{**start index** \}” și călătorește prin cât mai multe ținte indicate în: „\{**lungime** \}”.
...
Peter începe să se deplaseze în zona de tir cu arcul de la dreapta începând de la „\{**start index** \}” și călătorește prin cât mai multe ținte indicate în: „\{**lungime** \}”.
...
* Îl împușcă și primește 5 puncte, scăzând valoarea punctului total al țintei cu 5
...
* Trageți "**Right@6@5**" \-\> "**Index 6**" este în afara intervalului (nu există în interval), așa că Peter ignoră comanda
