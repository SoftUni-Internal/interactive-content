...
După aceea, până când este dată comanda „**Generare**”, veți primi șiruri cu instrucțiuni pentru diferite operațiuni care trebuie efectuate pe cheia de activare brută.

Există mai multe tipuri de instrucțiuni, împărțite la `>>>`:

* "**Conține** \>\>\>\{**sub șir**\}" - Verifică dacă cheia brută de activare conține subșirul dat

  - dacă se întâmplă, tipăriți: „\{**cheie de activare brută**\} **conține** \{**sub șir**\}”

  - dacă nu, tipăriți: „**Substring not found!**”

* "**Flip**\>\>\>**Superior/inferior**\>\>\>\{**startIndex**\}\>\>\>\{**endIndex**\} "- Schimbă șirul **între indicii dați (indexul final este exclusiv)** cu majuscule sau minuscule
...
După prima linie, până când este dată comanda „**Generare**”, veți primi șiruri.

### Ieșire

După primirea comenzii „**Generare**”, tipăriți:

"**Cheia dvs. de activare este:** \{**cheia de activare**\}"
