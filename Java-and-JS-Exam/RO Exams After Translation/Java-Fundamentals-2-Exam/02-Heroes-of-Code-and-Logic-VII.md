...
Veți primi comenzi diferite, fiecare pe o nouă linie, separate prin „ - ” (spațiu liniuță), până când este dată comanda „**Sfârșit**”.

Există mai multe acțiuni care pot fi efectuate de eroi:

- "**CastSpell -** \{**nume erou** \} - \{**MP necesar** \} - \{**nume ortografic** \}":
