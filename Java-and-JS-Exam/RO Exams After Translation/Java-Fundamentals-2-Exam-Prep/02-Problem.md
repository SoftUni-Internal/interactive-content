...
Veți primi **linii cu comenzi separate prin** "->" **până când veți primi** comanda "**Statistici**".

Există **trei comenzi posibile**:
- "Add->\{username\}" 
    - **verificați dacă numele de utilizator există și dacă se tipărește** - "\{nume de utilizator\} este deja înregistrat"
    - dacă nu există, atunci adăugați utilizatorul la colecția de utilizatori
- "Send->\{username\}->\{Email\}" 
    - adăugați mesajul \{E-mail\} la colecția de e-mailuri trimise din \{nume de utilizator\}
- "Delete->\{username\}"
    - ștergeți utilizatorul dat, dacă acesta există
    - dacă utilizatorul nu există, tipăriți „\{nume de utilizator\} nu a fost găsit!”
...
### Intrare
- Veți primi linii până când veți primi comanda „**Statistici**”
- Comenzile vor fi în formatul descris mai sus

### Ieșire
- Imprimați colecția în formatul descris mai sus după comanda „**Statistici**”

### Ieșire
Imprimați colecția în formatul descris mai sus după ce ați primit comanda „**Statistici**”.
